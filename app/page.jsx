...
export const metadata = {
  ...
  description:
    "Join Maurya's in Kamloops for Colombian Independence Night on Saturday, July 18th, 5–9 PM. General admission $45 includes a 3-course Colombian buffet, live cultural music, and community celebration. Kids under 12 free.",
  keywords: [
  ...
  openGraph: {
    ...
    description:
      "Saturday, July 18th · 5–9 PM. $45 general admission includes a 3-course Colombian buffet, cultural music & community celebration. Kids under 12 free. Get tickets now.",
    url: siteUrl,
  ...
  twitter: {
    ...
    title: "Colombian Independence Night at Maurya's | Kamloops",
    description:
      "July 18th · 5–9 PM. $45 admission · 3-course Colombian buffet · cultural music · kids under 12 free.",
    images: [`${siteUrl}/kdvposter.jpeg`],
  },
  robots: {
    index: true,
    follow: true,
