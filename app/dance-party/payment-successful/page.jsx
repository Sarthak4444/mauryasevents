...
export default function DancePartyPaymentSuccessful() {
  return (
      ...
      <div className="flex-1 flex justify-center items-center p-6">
        <div className="max-w-lg w-full border-2 border-[#d88728] rounded-lg p-8 text-center">
          ...
          <p className="text-gray-600 text-lg mb-6">
            Thank you for purchasing tickets! A confirmation email with your ticket details has been sent to your email address.
          </p>
