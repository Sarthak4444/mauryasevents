...
export default function DancePartyLanding() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await fetch("/api/dance-party/checkout", {
        method: "POST",
  ...
  return (
    <div>
        ...
        <div className="text-center">
          ...
          <div>
            ...
            <div className="mt-6 text-center">
              <div className="border-2 border-[#d88728] p-6 rounded-lg max-w-2xl mx-auto">
                <h2 className="font-bold text-lg mb-2">General Admission</h2>
                <p className="mb-4 text-gray-700">
                  Includes entry to Colombian Independence Night and our 3-course buffet featuring authentic Colombian appetizers, main courses, and dessert, vibrant cultural music and a vibrant welcoming community atmosphere.
                </p>
                ...
                <p className="mt-3 text-sm font-medium text-gray-600">Kids under 12 years of age free</p>
              </div>
            </div>
          </div>
        </div>
      ...
      <section id="booking-form" className="h-fit max-w-[1300px] mx-auto md:p-20 p-6 justify-center items-center mb-8">
        <h2 className="sr-only">Book Your Tickets</h2>
          ...
          <div className="flex items-start mb-4">
            ...
            <div className="ml-4 text-lg max-w-full">
              ...
              <div className={"text-sm text-gray-700 transition-all relative " + (showTerms ? "" : "max-h-10 overflow-hidden")}>
                <p><strong>1. Admission</strong><br />General admission includes entry to Colombian Independence Night, our 3-course buffet, and all event activities. Kids under 12 years of age are admitted free.</p>
